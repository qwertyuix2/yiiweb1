...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <div class="wrap">
            <?php
            NavBar::begin([
                'brandLabel' => '<i class="glyphicon glyphicon-fire"></i>',
            ...
            echo Nav::widget([
                ...
                'encodeLabels' => false,
                'items' => [['label' => 'สำนักงานสาธารณสุขจังหวัดเชียงใหม่']],
            ]);
            NavBar::end();
            ?>
        ...
        <footer class="footer">
            <div class="container">
                <p class="pull-left">&copy; สำนักงานสาธารณสุขจังหวัดเชียงใหม่ <?= date('Y') ?></p>

                <p class="pull-right"><?php echo "By YuiNakorn"; ?></p>
            </div>
        </footer>
